...
1. Base Machine :
   ...
   1.1. Now we will be moving towards creating Hardware Modules :
       To make Hardware Modules we will go to Modify Menu at the top left corner.

       <img width="1440" height="900" alt="image" src="https://github.com/user-attachments/assets/eccae919-d220-42e9-8b20-d0d2133cc870" />
